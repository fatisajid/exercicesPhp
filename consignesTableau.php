 ...
 *   Instructions :
 *   Créez un tableau associatif qui contient les informations suivantes :
 *  prénom, nom, et âge.
 ...
 *   Objectif : Créez un tableau multidimensionnel et accédez à
 *  ses éléments.
 *   Instructions :
 *   Créez un tableau multidimensionnel avec des informations sur
 *  plusieurs étudiants : prénom, nom, et note.
 ...
 *   Instructions :
 *   Utilisez le tableau multidimensionnel créé dans l'exercice
 *  précédent.
...
/** Exercice 8 : Boucle foreach pour parcourir un tableau 
 * associatif
 *   Objectif : Utilisez une boucle foreach pour parcourir un 
 * tableau associatif.
 *   Instructions :
 *   Créez un tableau associatif avec des noms d'animaux et 
 * leurs bruits (par exemple, "chien" => "aboiement").
 *   Utilisez une boucle foreach pour afficher chaque animal et
 *  son bruit.
 */
 ...
 *   Instructions :
 *   Créez deux tableaux : un contenant des prénoms et un autre 
 * contenant des noms de famille.
 *   Fusionnez ces deux tableaux pour créer un tableau de
 *  noms complets.
