<?php
 //Créer un fichier exerciceArithmetique.php
 ...
 * 
 * 2 . Utilisez les opérateurs arithmétiques pour calculer les variables
 *  avec les opérateurs suivants (addition +, soustraction -, multiplication * ,
 *  division / et modulo %), puis afficher le résultat
 */


/** Exercice 2 : Opération combinées
 *  Objectif : calculer ces même variables en utilisant la syntaxe
 *  des opérateur d'affectation combinés (+=)
 */

/** Exercice 3 : Incrémentation et décrémentation (préfixe = ++$variable)
 * Objectif : Calculer une variable avec l'incrémentation et la décrémentation
 *  en préfixe
 *
 ...
 * 
 * 3 . Remontez le temps et réduisez votre âge pour revenir à son état
 *  d'origine (postfixe)
 */
 ...
 * 
 * 1 . Déclarer 3 variables $note1,$note2,$note3 avec des valeurs entre
 *  1 et 20 ;
 * 
 *  2 . Calculer la moyenne des trois notes en utilisant les opérateurs
 *  arithmétiques (afficher le résultat);
 * 
 * 3 . utiliser l'opérateur d'affectation combiné pour ajouter 
 * une nouvelle note à la moyenne et afficher le résultat
 */
 ...
 * 
 * 2 . Utiliser l'opérateur modulo pour vérifier si $total est pair
 *  ou impair
 * 
 ...
 * 
 *  2 . L'utilisateur ajoute 3 articles à son panier,
 *  la quantité augmentera donc de 3;
 * 
 *  3 . L'utilisateur change d'avis sur 2 des articles et décide
 *  de les retirer
 * 
 ...
 * 
 *  2 . Convertir les KM en miles (1km = environ 0.621371),
 *  le calcul sera donc $kilometres * 0.621371
 * 
 */

/** Exercice 10 : Jeu
 *  Objectif : Calculer les points dans un jeu en incrémentant et 
 * décrémentant
 * 
