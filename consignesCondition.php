 ...
 * 
 *  Objectif : Ecrire une condition qui vérifie si une variable age
 *  est valide (entre 0 et 120)
 *  
 ...
 * 
 *  Objectif : Ecrire une condition qui applique une réduction de 10% si le montant est supérieur à 100 (créer une variable
 *  montant), et 5% si le montant est entre 50 et 100€, sinon, aucune réduction n'est appliquée
 * 
 */
/** Exercice 3 : Afficher le jour de la semaine
 * 
 *  Objectif : Ecrire une condition 'switch' pour afficher un message en fonction du jour de la semaine, le jour est donnée
 *  par une variable $jour en number (1 pour lundi, 2 pour mardi etc...)
 
 */

/** Exercice 4 : Comparaison de chaines de caractères
 *  Objectif : Ecrire une condition qui compare si deux variables
 *  sont identiques, la condition doit vérifier le type ET
 *  la valeur 
 */
/** Exercice 5 : Calcul de la moyenne
 *  
 *  Objectif : Ecrire un script qui vérifie si la moyenne trois 
 * notes est 
 * suffisante pour passer un examen, la moyenne
 *  doit être supérieure ou égale à 10 (afficher un message pour
 *  chacun
 *  des cas)
 */
/** Exercice 6 : Tester une variable indéfinie
 * 
 *  Objectif : Ecrire une condition qui utilisera 'isset()' pour vérifier 
 * si un variable $var est définie,
 *  si elle est définie, afficher sa valeur, sinon afficher un message
 *  indiquant qu'elle n'est pas définie
 ...
 * 
 *  Objectif : Ecrire une condition qui vérifie si une variable a une
 *  valeur paire ou impaire (utiliser modulo)
 * 
 */
