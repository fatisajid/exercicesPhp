...
// N'oubliez pas de vérifier sur votre navigateur à chaque
//  exercice 
 ...
 * 
 *  3 . Utiliser echo pour afficher le texte suivant :
 *  Hello World, Bienvenue sur mon premier script PHP;
 * 
 ...
 * 
 *  2 . Utiliser echo pour afficher le texte :
 *  Bonjour tout le monde !. Suivi d'un saut de ligne
 * 
 *  3 . Utiliser ensuite print pour afficher le texte :
 *  Aujourd'hui, nous sommes le (date d'aujourd'hui + mois d'aujourd'hui).
