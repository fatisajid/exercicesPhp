<?php
 //Créer un fichier exerciceBoucle.php
 ...
 * 
 *  Objectif : Créer une boucle while qui affiche les
 *  nombres pairs de 0 à 20
 * 
 */


/** Exercice 2 : Générer une liste d'années avec une boucle
 *  while
 * 
 *  Ojectif : Afficher les années de 2000 à l'année actuelle
 ...
 * 
 *  Objectif : Utiliser une boucle do...while pour afficher 
 * les multiples de 3 inférieurs à 30. S'assurer que le premier
 *  multiple est affiché même si la condition n'est pas remplie
 * 
 */
 ...
 * 
 *  Objectif : Créer une boucle for qui affiche une table 
 * de multiplication (de 1 à 10) pour un nombre donné
 * 
 */
